...
def authenticate_message(address, signature, message):
    """
    Authenticates a message using the Evrmore node's verifymessage command.

    Args:
        address (str): The address to be authenticated.
    ...
    authenticated = send_command('verifymessage', [address, signature, message])
